          ...
          if (isUserLoggedIn) {
              $.ajax({
                  ...
                  success: function(response) {
                      // Producto agregado con éxito, muestra una notificación
                      Swal.fire({
                          position: 'top-end',
                          icon: 'success',
                      ...
                      // Limpia o actualiza el carrito en el lado del cliente (ajusta según tu implementación)
                      // Ejemplo: cartInstance.clear();
                  },
              ...
              // Mostrar una alerta y redirigir al usuario a la página de inicio de sesión
              Swal.fire({
                  icon: 'info',
